...
const Header = React.memo(({
  ...
  return (
    <header className="relative w-full h-16 sm:h-[76px] bg-white border-b border-[#ECE5DB] px-2 sm:px-4 lg:px-6 flex items-center justify-between gap-2 sticky top-0 z-layout-header select-none overflow-visible" dir="rtl">
      ...
      <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0 ms-auto overflow-visible">
        <div className="relative z-layout-dropdown overflow-visible" ref={notifRef}>
          <button
            type="button"
          ...
          <AnimatePresence>
            {activeDropdown === 'notifications' && (
              <motion.div
                ...
                animate="visible"
                exit="exit"
                className="absolute mt-2 w-80 max-w-[calc(100vw-2rem)] bg-white border border-[#ECE5DB] rounded-2xl shadow-xl p-1 z-layout-dropdown overflow-hidden end-0 start-auto origin-top-end"
              >
        ...
        <div className="relative z-layout-dropdown overflow-visible" ref={profileRef}>
          <button
            type="button"
          ...
          <AnimatePresence>
            {activeDropdown === 'profile' && (
              <motion.div
                ...
                animate="visible"
                exit="exit"
                className="absolute mt-2 w-64 max-w-[calc(100vw-2rem)] bg-white border border-[#ECE5DB] rounded-2xl shadow-xl p-1.5 z-layout-dropdown end-0 start-auto origin-top-end"
              >
      ...
      <AnimatePresence>
        {mobileSearchOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="md:hidden absolute top-16 sm:top-[76px] inset-x-0 bg-white border-b border-[#ECE5DB] p-3 shadow-md z-layout-dropdown"
            dir="rtl"
          >
