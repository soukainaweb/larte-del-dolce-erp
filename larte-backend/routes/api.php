...
Route::middleware(['auth:sanctum', 'password.changed', 'throttle:api'])->group(function () {
    ...
    Route::prefix('orders')->middleware('permission:orders.view')->group(function () {
        ...
        Route::post('/{order}/approve', [OrderController::class, 'approveOrder'])->middleware('permission:orders.view');
        Route::post('/{order}/reject', [OrderController::class, 'reject'])->middleware('permission:orders.view');
        Route::get('/{order}/approval-history', [OrderController::class, 'approvalHistory']);
